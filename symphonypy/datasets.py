...
def pbmcs_10x_reference(
    ...
    url = "https://zenodo.org/record/7606070/files/pbmcs_10x_reference.h5ad"
...
def pancreatic_atlas(
    ...
    url = "https://zenodo.org/record/7606070/files/pancreas_plate-based_reference.h5ad"
    adata = read(file_path, backup_url=url, sparse=True, cache=True)
    return adata
...
def fetal_liver(
    ...
    url = "https://zenodo.org/record/7606070/files/fetal_liver_reference_3p.h5ad"
    adata = read(file_path, backup_url=url, sparse=True, cache=True)
    return adata
...
def kidney(
    ...
    url = "https://zenodo.org/record/7606070/files/kidney_healthy_fetal_reference.h5ad"
    adata = read(file_path, backup_url=url, sparse=True, cache=True)
    return adata
...
def t_cells(
    ...
    url = "https://zenodo.org/record/7606070/files/tbru_ref.h5ad"
    adata = read(file_path, backup_url=url, sparse=True, cache=True)
    return adata
...
def inflammatory_atlas(
    ...
    url = "https://zenodo.org/record/7606070/files/zhang_reference.h5ad"
    adata = read(file_path, backup_url=url, sparse=True, cache=True)
    return adata
...
def TMS(
    ...
    url = "https://zenodo.org/record/7606070/files/TMS_facs_reference.h5ad"
    adata = read(file_path, backup_url=url, sparse=True, cache=True)
    return adata
